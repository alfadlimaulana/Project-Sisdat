...
$books = query("SELECT * FROM peminjaman NATURAL JOIN anggota");
    ...
    <div class="container-fluid tabel-katalog overflow-auto" >
      ...
      <table class="table table-dark" id="dtBasicExample">
        ...
        <tbody>
          ...
          <tr>
            <th scope="row"><?= $book["Kode_Pinjam"]; ?></th>
            <td><?= $book["Kode_Buku"]; ?></td>
            <td><?= $book["Username_Anggota"]; ?></td>
            <td><?= $book["Alamat_Anggota"]; ?></td>
            <td><?= $book["Tanggal_Pinjam"]; ?></td>
            <td><?= $book["Batas_Kembali"]; ?></td>
          </tr>
          <?php  endforeach; ?>
        </tbody>
      </table>
